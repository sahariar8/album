        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-promo promo2">
                    ...
                    <a href="{{route('occasion')}}"  style="color: white; text-decoration:none"><p>Occasions</p></a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="single-promo promo3">
                    <i class="fa-solid fa-calendar-day"></i>
                    <a href="{{route('regular')}}"  style="color: white; text-decoration:none"><p>Regular</p></a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="single-promo promo4">
                    <i class="fa-solid fa-face-laugh-wink"></i>
                    <a href="{{route('tour')}}"  style="color: white; text-decoration:none"><p>Tour</p></a>
                </div>
            </div>
        </div>
    </div>
