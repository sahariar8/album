...
@section('special')
   <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h1 class="text-primary py-5 text-center" style="font-family: roboto">Insert Occasional Picture & Details</h1>
                <h2 class="text-success text-center">{{Session::get('msg')}}</h2>
                <form action="{{route('occasion.insert')}}" method="post" enctype="multipart/form-data" class="border p-5 rounded">
                    @csrf
                    ...
                    <div class="form-group my-2">
                      ...
                      <input type="file" class="form-control" name="oimg" required>
                    </div>
