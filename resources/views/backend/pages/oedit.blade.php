   ...
   <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="{{route('oupdate',$occasion->id)}}" method="post" enctype="multipart/form-data" class="border p-5 rounded">
                    @csrf
                    <div class="form-group my-2">
                      <label for="title" class="my-2"><b>Image Title :</b></label>
                      <input type="text" class="form-control" name="title" value="{{$occasion->title}}">
                    </div>
                    <div class="form-group my-2">
                      <label for="date" class="my-2"><b>Date</b></label>
                      <input type="datetime-local" class="form-control" name="date" value="{{$occasion->date}}">
                    </div>
                    <div class="form-group my-2">
                      <label for="desc" class="my-2"><b>Image Description</b></label>
                      <input type="text" class="form-control" name="desc" value="{{$occasion->desc}}">
                    </div>
                    <div class="form-group my-2">
                        <label for="img" class="my-2"><b>Existing Image</b></label>
                        <img src="{{asset('/')}}{{$occasion->oimg}}" alt="" height="80px" width="100px">
                    </div>
                    <div class="form-group my-2">
