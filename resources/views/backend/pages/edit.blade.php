   ...
   <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="{{route('update',$picture->id)}}" method="post" enctype="multipart/form-data" class="border p-5 rounded">
                    @csrf
                    ...
                    <div class="form-group my-2">
                      ...
                      <input type="datetime-local" class="form-control" name="date" value="{{$picture->date}}">
                    </div>
                    <div class="form-group my-2">
                      <label for="desc" class="my-2"><b>Image Description</b></label>
                      <input type="text" class="form-control" name="desc" value="{{$picture->desc}}">
                    </div>
                    <div class="form-group my-2">
                        <label for="img" class="my-2"><b>Existing Image</b></label>
                        <img src="{{asset('/')}}{{$picture->img}}" alt="" height="80px" width="100px">
                    </div>
                    <div class="form-group my-2">
